...
INSERT INTO `ci_admin` VALUES (1,'admin','7fef6171469e80d32c0559f88b377245',1,'先生/女士','17701030513',NULL,0,NULL,NULL,NULL,NULL,'');
...
--
-- Table structure for table `ci_invoice_img`
--
...
--
-- Dumping data for table `ci_invoice_img`
--

LOCK TABLES `ci_invoice_img` WRITE;
/*!40000 ALTER TABLE `ci_invoice_img` DISABLE KEYS */;
/*!40000 ALTER TABLE `ci_invoice_img` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ci_log` VALUES (1380,NULL,'::1',NULL,'登陆成功 用户名：admin',1,NULL,'2015-12-17 18:08:40','','2015-12-17'),(1381,NULL,'::1',NULL,'登陆成功 用户名：admin',1,NULL,'2015-12-17 18:09:19','','2015-12-17'),(1382,1,'::1','小阳','密码修改成功 UID：1 真实姓名改为：模板俱乐部',1,'admin','2015-12-17 18:09:43','','2015-12-17'),(1383,NULL,'::1',NULL,'登陆成功 用户名：admin',1,NULL,'2015-12-17 18:09:51','','2015-12-17'),(1384,1,'::1','模板俱乐部','系统设置成功',1,'admin','2015-12-17 18:10:30','','2015-12-17'),(1385,NULL,'127.0.0.1',NULL,'登陆成功 用户名：admin',1,NULL,'2019-12-19 13:34:16','','2019-12-19'),(1386,1,'127.0.0.1','煌嘉科技','系统设置成功',1,'admin','2019-12-19 13:34:28','','2019-12-19'),(1387,1,'127.0.0.1','煌嘉科技','强制密码修改成功 UID：1',1,'admin','2019-12-19 13:34:51','','2019-12-19'),(1388,1,'127.0.0.1','煌嘉科技','切换皮肤：blue',1,'admin','2019-12-19 13:37:31','','2019-12-19'),(1389,1,'127.0.0.1','煌嘉科技','切换皮肤：green',1,'admin','2019-12-19 13:37:34','','2019-12-19'),(1390,NULL,'127.0.0.1',NULL,'登陆成功 用户名：admin',1,NULL,'2019-12-19 13:37:43','','2019-12-19'),(1391,1,'127.0.0.1','煌嘉科技','系统设置成功',1,'admin','2019-12-19 13:40:02','','2019-12-19');
...
--
-- Table structure for table `ci_verifica_info`
--
...
--
-- Dumping data for table `ci_verifica_info`
--

LOCK TABLES `ci_verifica_info` WRITE;
/*!40000 ALTER TABLE `ci_verifica_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `ci_verifica_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ci_warehouse`
--
...
--
-- Dumping data for table `ci_warehouse`
--

LOCK TABLES `ci_warehouse` WRITE;
/*!40000 ALTER TABLE `ci_warehouse` DISABLE KEYS */;
/*!40000 ALTER TABLE `ci_warehouse` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-19 13:41:37
